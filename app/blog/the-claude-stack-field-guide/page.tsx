        ...
        <article className="post">
          <Reveal>
            <header className="post-header">
              ...
              <p className="post-lead">
                ...
                answer. That&apos;s real — but it&apos;s the smallest version
                of the product. This is my field guide to the whole stack, from
          ...
          <div className="post-body">
            ...
            <p>
              ...
              product. The names change several times a year; the tier logic
              doesn&apos;t. There&apos;s always a <strong>sprinter</strong>{' '}
              (Haiku — quick, high-volume jobs), a{' '}
              <strong>daily driver</strong> (Sonnet — roughly 80% of tasks), a{' '}
              <strong>specialist</strong> (Opus — genuinely hard problems), and
              a <strong>frontier</strong> tier (Fable — the work that actually
              deserves maximum intelligence).
            </p>
            <p>
              Start on the daily driver. Step down when the task is clearly
              simple; step up only when a hard problem&apos;s answer feels
            ...
            <ul>
              <li>
                ...
                files are cached — asking about them again barely touches your
                limits.
              </li>
              <li><strong>Batch your questions</strong> — one message with five questions beats five messages.</li>
              <li><strong>Front-load context</strong> — files, constraints, and desired format up front.</li>
...
directly with a simple payback framing."`}</code></pre>
            <p>
              ...
              with simple tags, and make it push back —{' '}
            ...
            <p>
              ...
              <strong>Translator</strong> (transcript → action list).
            </p>
            <div className="callout">
              One Skill saves minutes. A library of eight changes your job. The
              moat is not access to AI — everyone has access. The moat is
            ...
            <p>
              ...
              use — Gmail, Calendar, Drive, Slack, Notion. Underneath is MCP,
              an open standard doing for AI tools what USB did for hardware:
              one plug shape, everything fits. The value isn&apos;t any single
...
to chase the contract Friday."`}</code></pre>
            <p>
              ...
              of rebuilding — then add your own Skills on top.
            </p>
            ...
            <p>
              ...
              developer to use it — non-developers use it to build small
              friction-removing tools, fix inherited scripts, and make ideas
              touchable as prototypes.
            </p>
            <p>
              ...
              questions — Cowork finishes tasks.
            </p>
            ...
            <div className="post-cta">
              <p>
                Want the full version — with worked examples, the seven
                beginner mistakes, and a complete Skill you can copy?
              </p>
              <a
                href="/downloads/the-claude-stack-field-guide.pdf"

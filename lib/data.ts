...
export const skillGroups = [
  {
    label: 'Salesforce',
    skills: ['Apex', 'Lightning Web Components', 'Salesforce Admin', 'Agentforce', 'Flows'],
  },
  {
    label: 'Languages',
  ...
  },
  {
    ...
    skills: ['React', 'Next.js', 'Node.js', 'NoSQL', 'Git'],
  },
];
...
export const experience = [
  ...
  },
  {
    ...
    description:
      'Studied software engineering, databases, and systems design. Winner of the Vertex and NSU hackathons.',
  },
];
...
export const certifications = [
  { name: 'Agentforce Specialist', year: '2025' },
  { name: 'Full Stack Next.js Training', year: '2024' },
  { name: 'React.js Essential Training', year: '2023' },
];

export const achievements = [
  'Vertex Hackathon Winner',
  'NSU Hackathon Winner',
  'Trailhead Expeditioner',
];
